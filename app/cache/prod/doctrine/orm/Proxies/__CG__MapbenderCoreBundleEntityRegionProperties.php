 ...
 */
class RegionProperties extends \Mapbender\CoreBundle\Entity\RegionProperties implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'application', 'name', 'properties'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RegionProperties $proxy) {
