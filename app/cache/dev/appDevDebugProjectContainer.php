...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $c->addEventSubscriber($this->get('fom.security.user_profile_listener'));
        $c->addEventSubscriber($this->get('fom.user.subscriber'));
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => 'localhost', 'port' => 5432, 'dbname' => 'mapbender', 'path' => NULL, 'user' => 'postgres', 'password' => 'postgres', 'persistent' => true, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    public function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['doctrine.orm.default_entity_manager'] = new DoctrineORMEntityManager_0000000047181e2e00000000241a20573a1fb862c4a842e98f26812424157d7c(
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_411b12626d72b0d2a11d7037c63857ceb5eda0b72f3f7eb8bfbb2e90d70bb07b');
    ...
    {
        return $this->services['mapbender.element_factory.service'] = new \Mapbender\CoreBundle\Component\ElementFactory($this->get('translator'), $this);
    }
    ...
    {
        return $this->services['mapbender.presenter.application.cache'] = new \Mapbender\CoreBundle\Component\Cache\ApplicationDataService($this->get('logger'), $this->get('mapbender.presenter.application.cache.backend'), 1563193894.843203);
    }
    ...
    {
        return $this->services['mapbender.validator.twig'] = new \Mapbender\CoreBundle\Validator\Constraints\TwigConstraintValidator($this->get('translator'));
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig\Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'form_themes' => array(0 => 'form_div_layout.html.twig', 1 => 'MapbenderCoreBundle:form:fields.html.twig'), 'autoescape' => 'name', 'cache' => (__DIR__.'/twig'), 'charset' => 'UTF-8', 'paths' => array(), 'date' => array('format' => 'F j, Y H:i', 'interval_format' => '%d days', 'timezone' => NULL), 'number_format' => array('decimals' => 0, 'decimal_point' => '.', 'thousands_separator' => ',')));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'FrameworkBundle', 1 => 'SecurityBundle', 2 => 'TwigBundle', 3 => 'MonologBundle', 4 => 'AsseticBundle', 5 => 'DoctrineBundle', 6 => 'SensioFrameworkExtraBundle', 7 => 'DoctrineMigrationsBundle', 8 => 'MapbenderCoreBundle', 9 => 'WebProfilerBundle', 10 => 'SensioDistributionBundle', 11 => 'SensioGeneratorBundle', 12 => 'SwiftmailerBundle', 13 => 'FOMCoreBundle', 14 => 'FOMManagerBundle', 15 => 'FOMUserBundle', 16 => 'MapbenderWmcBundle', 17 => 'MapbenderWmsBundle', 18 => 'MapbenderManagerBundle', 19 => 'MapbenderPrintBundle', 20 => 'MapbenderMobileBundle', 21 => 'OwsProxy3CoreBundle', 22 => 'DoctrineFixturesBundle', 23 => 'MapbenderDigitizerBundle', 24 => 'MapbenderDataSourceBundle', 25 => 'MapbenderCoordinatesUtilityBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/MapbenderCoreBundle/views'), 'MapbenderCore');
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/FOMUserBundle/views'), 'FOMUser');
        ...
        $instance->addPath(($this->targetDirs[2].'/Resources/MapbenderManagerBundle/views'), 'MapbenderManager');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.bundles' => array(
                ...
                12 => 'SwiftmailerBundle',
                13 => 'FOMCoreBundle',
                14 => 'FOMManagerBundle',
                15 => 'FOMUserBundle',
                16 => 'MapbenderWmcBundle',
                17 => 'MapbenderWmsBundle',
                18 => 'MapbenderManagerBundle',
                19 => 'MapbenderPrintBundle',
                20 => 'MapbenderMobileBundle',
                21 => 'OwsProxy3CoreBundle',
                22 => 'DoctrineFixturesBundle',
                23 => 'MapbenderDigitizerBundle',
                24 => 'MapbenderDataSourceBundle',
                25 => 'MapbenderCoordinatesUtilityBundle',
            ),
            ...
            'mapbender.cache_creation' => '2019-07-15T12:31:34+00:00',
            0 => '3.0.2',
            ...
            'console.command.ids' => array(
                ...
                32 => 'sensio_distribution.security_checker.command',
                33 => 'doctrine.fixtures_load_command',
            ),
            'container.compilation_timestamp_float' => 1563193894.843203,
        );
    }
}

class DoctrineORMEntityManager_0000000047181e2e00000000241a20573a1fb862c4a842e98f26812424157d7c extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5d2c7226eb361090511901 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5d2c7226eb374355688530 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5d2c7226eb30b950146766 = array(
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getConnection', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getConnection();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getMetadataFactory', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getMetadataFactory();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getExpressionBuilder', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getExpressionBuilder();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'beginTransaction', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->beginTransaction();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getCache', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getCache();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'transactional', array('func' => $func), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->transactional($func);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'commit', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->commit();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'rollback', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->rollback();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getClassMetadata', array('className' => $className), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getClassMetadata($className);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'createQuery', array('dql' => $dql), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->createQuery($dql);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'createNamedQuery', array('name' => $name), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->createNamedQuery($name);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->createNativeQuery($sql, $rsm);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->createNamedNativeQuery($name);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'createQueryBuilder', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->createQueryBuilder();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'flush', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->flush($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'find', array('entityName' => $entityName, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->find($entityName, $id, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getReference($entityName, $id);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getPartialReference($entityName, $identifier);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'clear', array('entityName' => $entityName), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->clear($entityName);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'close', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->close();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'persist', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->persist($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'remove', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->remove($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'refresh', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->refresh($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'detach', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->detach($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'merge', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->merge($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->copy($entity, $deep);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->lock($entity, $lockMode, $lockVersion);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getRepository', array('entityName' => $entityName), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getRepository($entityName);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'contains', array('entity' => $entity), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->contains($entity);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getEventManager', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getEventManager();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getConfiguration', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getConfiguration();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'isOpen', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->isOpen();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getUnitOfWork', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getUnitOfWork();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->newHydrator($hydrationMode);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getProxyFactory', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getProxyFactory();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'initializeObject', array('obj' => $obj), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->initializeObject($obj);
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'getFilters', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->getFilters();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'isFiltersStateClean', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->isFiltersStateClean();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'hasFilters', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return $this->valueHolder5d2c7226eb361090511901->hasFilters();
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 = $initializer;
    }
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, '__get', array('name' => $name), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        if (isset(self::$publicProperties5d2c7226eb30b950146766[$name])) {
            return $this->valueHolder5d2c7226eb361090511901->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5d2c7226eb361090511901;
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, '__isset', array('name' => $name), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, '__unset', array('name' => $name), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;
    ...
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, '__clone', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        $this->valueHolder5d2c7226eb361090511901 = clone $this->valueHolder5d2c7226eb361090511901;
    }

    public function __sleep()
    {
        $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, '__sleep', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;

        return array('valueHolder5d2c7226eb361090511901');
    }
    ...
    {
        return $this->initializer5d2c7226eb374355688530;
    }
    ...
    {
        return $this->initializer5d2c7226eb374355688530 && ($this->initializer5d2c7226eb374355688530->__invoke($valueHolder5d2c7226eb361090511901, $this, 'initializeProxy', array(), $this->initializer5d2c7226eb374355688530) || 1) && $this->valueHolder5d2c7226eb361090511901 = $valueHolder5d2c7226eb361090511901;
    }
    ...
    {
        return null !== $this->valueHolder5d2c7226eb361090511901;
    }
    ...
    {
        return $this->valueHolder5d2c7226eb361090511901;
    }
