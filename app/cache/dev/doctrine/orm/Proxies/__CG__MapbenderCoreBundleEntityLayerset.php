 ...
 */
class Layerset extends \Mapbender\CoreBundle\Entity\Layerset implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'title', 'application', 'instances'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Layerset $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addInstance(\Mapbender\CoreBundle\Entity\SourceInstance $instance)
    {
