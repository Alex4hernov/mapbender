...
class __TwigTemplate_fb618ebc2e271add0f082f6c588f8f17b2295559092d50db0d7a6f3019aac02e extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02->enter($__internal_319393461309892924ff6e74d6d6e64287df64b63545b994e100d4ab223aed02_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "@MapbenderManager/Repository/new.html.twig"));
...
";
    ...
    {
        return array (  171 => 21,  156 => 19,  154 => 18,  145 => 17,  128 => 16,  125 => 15,  102 => 13,  85 => 12,  81 => 10,  75 => 9,  65 => 6,  59 => 5,  47 => 3,  31 => 1,);
    }
...
<div id=\"sourceTabContainer\" class=\"tabContainer sourceTabContainer\">
  <ul class=\"tabs\">
{% for name, manager in managers %}
    <li id=\"tab{{loop.index}}\" class=\"tab{% if loop.first %} active{% endif %}\">{{manager.label }}</li>
{% endfor %}
  </ul>
{% for name, manager in managers %}
  <div id=\"container{{loop.index}}\" class=\"container containerBaseData{% if loop.first %} active{% endif %}\">
    {% render controller(manager.startAction) %}
  </div>
{% endfor %}
</div>
{% endblock %}
", "@MapbenderManager/Repository/new.html.twig", "/var/www/mapbender/mapbender/src/Mapbender/ManagerBundle/Resources/views/Repository/new.html.twig");
    }
}
